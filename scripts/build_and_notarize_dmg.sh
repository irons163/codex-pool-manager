...
SWIFT_ACTIVE_COMPILATION_CONDITIONS_OVERRIDE="${SWIFT_ACTIVE_COMPILATION_CONDITIONS_OVERRIDE:-}"
...
if [[ -n "$SWIFT_ACTIVE_COMPILATION_CONDITIONS_OVERRIDE" ]]; then
  XCODEBUILD_ARGS+=(SWIFT_ACTIVE_COMPILATION_CONDITIONS="$SWIFT_ACTIVE_COMPILATION_CONDITIONS_OVERRIDE")
fi
